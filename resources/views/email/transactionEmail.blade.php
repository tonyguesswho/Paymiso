...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0" marginheight="0" marginwidth="0" style="-webkit-font-smoothing: antialiased; width: 100% !important; -webkit-text-size-adjust: none; margin: 0; padding: 0">
                        ...
                        <table class="title-subtitle-root" width="100%" cellpadding="0" cellspacing="0" style="border: none; margin: 0px; border-collapse: collapse; padding: 0px; width: 100%;">
                            <tbody valign="middle" style="border: none; margin: 0px; padding: 0px;">
                                ...
                                <tr valign="middle" style="border: none; margin: 0px; padding: 0px;">
                                    <td width="6.25%" valign="middle" style="border: none; margin: 0px; padding: 0px; width: 6.25%;"></td>
                                    <td valign="middle" style="border: none; margin: 0px; padding: 0px;">
                                            <h1 class="font title-subtitle-title" align="center" style="border: none; margin: 0px; padding: 0px; font-family: Circular, 'Helvetica Neue', Helvetica, Arial, sans-serif; text-decoration: none; color: rgb(85, 85, 85); font-size: 40px; font-weight: bold;          line-height: 45px; letter-spacing: -0.04em; text-align: center;">
  ...
  Kindly go through the details below before making payment
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0px; padding: 0px">
                                            <tbody>
                                                <tr>
                                                    <td class="font text-paragraph" align="left" style="border: none; margin: 0px; padding: 0px 0px 5px; font-family: Circular, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: bold; text-align: left; text-decoration: none; color: rgb(97, 100, 103); font-size: 16px; line-height: 20px;">
                                                        <center style="border: none; margin: 0px; padding: 0px;">
                                                                        ...
                                                                        <table cellspacing="0" cellpadding="0" width="100%" style="margin: 0px; padding: 0px; width: 100%">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="20%" valign="middle" style="text-align: right; width: 20%; vertical-align: top; font-family:'Circular', 'Helvetica Neue', Helvetica, Arial, sans-serif;">
                                                                                      {{number_format($sellcoin->amount_dollar*$sellcoin->rate,2)}}
                                                                                    </td>
                                                                                    <td width="5%" valign="middle" style="border: none; margin: 0px; padding: 0px; width: 5%;"></td>
                                                                                </tr>
                                                                        ...
                                                                        <table cellspacing="0" cellpadding="0" width="100%" style="margin: 0px; padding: 0px; width: 100%">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="20%" valign="middle" style="text-align: right; width: 20%; vertical-align: top; font-family:'Circular', 'Helvetica Neue', Helvetica, Arial, sans-serif;">
                                                                                     {{number_format(($sellcoin->amount_dollar*$sellcoin->rate)*0.0075,2)}}
                                                                                    </td>
                                                                                    <td width="5%" valign="middle" style="border: none; margin: 0px; padding: 0px; width: 5%;"></td>
                                                                                </tr>
  ...
  Total  (NGN)
                                                                                    ...
                                                                                    <td width="20%" valign="middle" style="text-align: right; width: 20%; vertical-align: top; font-family:'Circular', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: bold;">
                                                                                        {{$sellcoin->amount_dollar*$sellcoin->rate + (($sellcoin->amount_dollar*$sellcoin->rate)*0.0075)}}
                                                                                    </td>
                                                                                    <td width="5%" valign="middle" style="border: none; margin: 0px; padding: 0px; width: 5%;"></td>
                                                                                </tr>
                                                                                <tr class="purchase-details-padding" height="10" valign="middle" style="border: none; margin: 0px; padding: 0px; height: 10px;">
  ...
  <a class="buttonText" href="{{route('payEmailDone',['id' => $sellcoin->Transaction->sell_coin_id,'token' => $sellcoin->Transaction->transaction_token])}}" target="_blank" style="color: #ffffff;text-decoration: none;font-weight: normal;display: block;padding: 10px 80px;font-family: Arial; background: #4caf50; box-shadow: 0 2px 2px 0 rgba(76, 175, 80, 0.14), 0 3px 1px -2px rgba(76, 175, 80, 0.2), 0 1px 5px 0 rgba(76, 175, 80, 0.12);">CONFIRM</a>
 ...
 <a class="buttonText" href="{{route('cancelEmailDone',['id'=>$sellcoin->Transaction->sell_coin_id,'token'=>$sellcoin->Transaction->transaction_token])}}" target="_blank" style="color: #ffffff;text-decoration: none;font-weight: normal;display: block;padding: 10px 80px;font-family: Arial; background: #f44336; box-shadow: 0 2px 2px 0 rgba(244, 67, 54, 0.14), 0 3px 1px -2px rgba(244, 67, 54, 0.2), 0 1px 5px 0 rgba(244, 67, 54, 0.12);">CANCEL</a>
</center>
...
For further information contact <a href="mailto:support@paymiso.com">support@paymiso.com</a>
                                                    </font>
                                                </center>
                                            </td>
                                        </tr>
                        ...
                        <table class="footer-root" width="100%" cellpadding="0" cellspacing="0" bgcolor="#F7F7F7" style="border: none; margin: 0px; border-collapse: collapse; padding: 0px; width: 100%; background-color: rgb(247, 247, 247);">
                            <tbody valign="middle" style="border: none; margin: 0px; padding: 0px;">
                                ...
                                <tr valign="middle" style="border: none; margin: 0px; padding: 0px;">
                                    <td width="6.25%" valign="middle" style="border: none; margin: 0px; padding: 0px; width: 6.25%;"></td>
                                    <td valign="middle" style="border: none; margin: 0px; padding: 0px;"><img class="footer-logo" src="" width="77" height="23" alt="paymiso" style="border: none; margin: 0px; padding: 0px; display: block; max-width: 100%; width: 77px; height: 23px;"></td>
                                    <td width="6.25%" valign="middle" style="border: none; margin: 0px; padding: 0px; width: 6.25%;"></td>
                                </tr>
                                <tr class="footer-bottom-padding" height="25" valign="middle" style="border: none; margin: 0px; padding: 0px; height: 25px;">
                                    <td colspan="3" class="footer-bottom-padding" height="25" valign="middle" style="border: none; margin: 0px; padding: 0px; height: 25px;"></td>
                                ...
                                <tr valign="middle" style="border: none; margin: 0px; padding: 0px;">
                                    ...
                                    <td class="font font-small" valign="middle" align="left" style="border: none; margin: 0px; padding: 0px; font-family: Circular, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: 200; text-align: left; text-decoration: none; color: rgb(136, 137, 140); line-height: 1.65em; font-size: 11px;">
                                      Roar Nigeria Hub University of Nigeria Nsukka, Enugu State, Nigeria.
                                    </td>
                                    <td width="6.25%" valign="middle" style="border: none; margin: 0px; padding: 0px; width: 6.25%;"></td>
                                </tr>
